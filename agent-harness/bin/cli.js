...
// Generated by metaharness — the `ruvdrone` CLI entry point.
//
// This is plain ESM JavaScript on purpose: it runs as-is via `npx ruvdrone`
...
// "bin" + "files" fields in package.json), so `npx ruvdrone` works the moment
...
const HARNESS_NAME = 'ruvdrone';

/** `ruvdrone init` — boot the kernel + host adapter and report status. */
async function init() {
...
/** `ruvdrone doctor` — verify the install end-to-end (kernel + host resolve). */
